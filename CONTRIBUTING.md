...
Only `publication-files.json` entries are public. Run `python scripts/privacy_audit.py --zip releases/Clickable-Scrollbars-v2.6.zip --git` after staging a release to check the source inventory, archive metadata and Git history.
